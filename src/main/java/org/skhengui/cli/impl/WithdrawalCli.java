...
public class WithdrawalCli implements Cli {
    private final BalanceService balanceService;
    private final UserService userService;
    private final UserThreadLocal userThreadLocal = new UserThreadLocal();

    public WithdrawalCli(BalanceService balanceService, UserService userService) {
    ...
    public void display() {
        ...
        User updatedUser = this.balanceService.withdraw(user, BigDecimal.valueOf(in.nextDouble()));
